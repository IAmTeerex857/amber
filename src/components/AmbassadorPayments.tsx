...
import {
  ...
  TrendingUp, CheckCircle, Clock, AlertCircle, AlertTriangle, Star,
  Copy, ExternalLink, RefreshCw, Download, Search,
  Filter, MoreHorizontal, ArrowUpRight, ArrowDownLeft,
  DollarSign, Calendar, Send, X, FileText, Tag
} from 'lucide-react';

// Tab types for the unified payments interface
type PaymentTab = 'overview' | 'fund-requests' | 'wallets' | 'points' | 'rewards' | 'transactions';
...
const AmbassadorPayments: React.FC = () => {
  ...
  const tabs = [
    ...
    { id: 'fund-requests', name: 'Fund Requests', icon: DollarSign },
  ...
  // Helper functions for fund requests
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6">
          ...
          <h3 className="text-2xl font-bold text-orange-600">{paymentOverview.pendingEarnings}</h3>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6">
          ...
          <h3 className="text-2xl font-bold text-green-600">{paymentOverview.totalEarnings}</h3>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6">
          ...
          <h3 className="text-2xl font-bold text-blue-600">{paymentOverview.thisMonth}</h3>
